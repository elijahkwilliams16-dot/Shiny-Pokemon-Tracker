...
class Pokemon(db.Model):
    ...
    shiny_sprite_url = db.Column(db.String(500))
...
class Shiny(db.Model):
    ...
    date_caught = db.Column(db.String(20), nullable=False)

    # Sprite specifically for this shiny/game combination
    shiny_sprite_url = db.Column(db.String(500))

    pokemon = db.relationship("Pokemon", backref="shinies")
    game = db.relationship("Game", backref="shinies")